...
public class VentanaAgregarInstructor {
	...
	public VentanaAgregarInstructor() {
		initialize();
	}
	
	private void initialize() {
		frame = new JDialog();
		frame.setSize(276, 502);
		frame.getContentPane().setLayout(null);
		frame.setLocationRelativeTo(null);
		frame.setModal(true);
		frame.setResizable(false);
		frame.setTitle("Agregar Instructor");
		...
		btnAgregarInstructor.setBounds(23, 439, 221, 23);
		btnAgregarInstructor.setBackground(style.getBackgroundButtonStandard());
		btnAgregarInstructor.setForeground(style.getForegroundButtonStandard());
		frame.getContentPane().add(btnAgregarInstructor);
