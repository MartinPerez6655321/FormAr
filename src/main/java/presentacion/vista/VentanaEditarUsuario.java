...
public class VentanaEditarUsuario {
	...
	private JCheckBox checkBoxDisponibilidad;
	...
	private void initialize() {
		...
		btnEditarUsuario.setBounds(23, 582, 221, 23);
		btnEditarUsuario.setBackground(style.getBackgroundButtonStandard());
		btnEditarUsuario.setForeground(style.getForegroundButtonStandard());
		...
		separator_1.setBounds(23, 540, 221, 2);
		frame.getContentPane().add(separator_1);

		checkBoxDisponibilidad = new JCheckBox("Disponibilidad");
		checkBoxDisponibilidad.setBounds(77, 549, 120, 23);
		frame.getContentPane().add(checkBoxDisponibilidad);
	...
	public JCheckBox getCheckBoxDisponibilidad() {
		return checkBoxDisponibilidad;
	}
